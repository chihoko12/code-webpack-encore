...
class __TwigTemplate_8c111870667e8db10c4630306434d54e585d13bb58a0925198d49053f062caad extends \Twig\Template
{
    private $source;
    private $macros = [];
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["profile"]) {
                ...
                <div class=\"httplug-messages\">
                    <div class=\"httplug-message\">
                        ...
                        ";
                // line 52
                echo twig_nl2br($this->extensions['Http\HttplugBundle\Collector\Twig\HttpMessageMarkupExtension']->markup(twig_get_attribute($this->env, $this->source, $context["profile"], "request", [], "any", false, false, false, 52)));
                echo "
                    </div>
                    <div class=\"httplug-message\">
                        <h4>Response</h4>
                        ";
                // line 56
                echo twig_nl2br($this->extensions['Http\HttplugBundle\Collector\Twig\HttpMessageMarkupExtension']->markup(twig_get_attribute($this->env, $this->source, $context["profile"], "response", [], "any", false, false, false, 56)));
                echo "
                    </div>
                </div>
                ";
...
{% endfor %}
", "@Httplug/stack.html.twig", "/app/vendor/php-http/httplug-bundle/src/Resources/views/stack.html.twig");
    }
}
