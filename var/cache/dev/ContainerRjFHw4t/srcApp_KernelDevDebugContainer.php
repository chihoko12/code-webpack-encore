...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'oneup_flysystem.cached_uploads_filesystem_filesystem' => 'getOneupFlysystem_CachedUploadsFilesystemFilesystemService',
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\ArticleReferenceAdminController' => 'getArticleReferenceAdminControllerService.php',
            ...
            'liip_imagine.binary.loader.flysystem_loader' => 'getLiipImagine_Binary_Loader_FlysystemLoaderService.php',
            ...
            'oneup_flysystem.uploads_filesystem_filesystem' => 'getOneupFlysystem_UploadsFilesystemFilesystemService.php',
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once \dirname(__DIR__, 4).'/vendor/league/flysystem-cached-adapter/src/CachedAdapter.php';
            include_once \dirname(__DIR__, 4).'/vendor/league/flysystem-cached-adapter/src/CacheInterface.php';
            include_once \dirname(__DIR__, 4).'/vendor/league/flysystem-cached-adapter/src/Storage/AbstractCache.php';
            include_once \dirname(__DIR__, 4).'/vendor/league/flysystem-cached-adapter/src/Storage/Psr6Cache.php';
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        ]), [0 => 'stof_doctrine_extensions.listener.sluggable', 1 => 'stof_doctrine_extensions.listener.timestampable']);
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\ApiTokenRepository' => ['privates', 'App\\Repository\\ApiTokenRepository', 'getApiTokenRepositoryService.php', true],
            'App\\Repository\\ArticleReferenceRepository' => ['privates', 'App\\Repository\\ArticleReferenceRepository', 'getArticleReferenceRepositoryService.php', true],
            ...
            'App\\Repository\\ArticleReferenceRepository' => '?',
    ...
    {
        return $this->services['liip_imagine.cache.resolver.flysystem_resolver'] = new \Liip\ImagineBundle\Imagine\Cache\Resolver\FlysystemResolver(($this->services['oneup_flysystem.cached_uploads_filesystem_filesystem'] ?? $this->getOneupFlysystem_CachedUploadsFilesystemFilesystemService()), ($this->privates['router.request_context'] ?? $this->getRouter_RequestContextService()), $this->getEnv('string:SITE_BASE_URL').'/uploads', 'media/cache', 'public');
    }
    ...
    /**
     * Gets the public 'oneup_flysystem.cached_uploads_filesystem_filesystem' shared service.
     *
     * @return \League\Flysystem\Filesystem
     */
    protected function getOneupFlysystem_CachedUploadsFilesystemFilesystemService()
    {
        return $this->services['oneup_flysystem.cached_uploads_filesystem_filesystem'] = new \League\Flysystem\Filesystem(new \League\Flysystem\Cached\CachedAdapter(($this->privates['oneup_flysystem.uploads_adapter_adapter'] ?? $this->getOneupFlysystem_UploadsAdapterAdapterService()), new \League\Flysystem\Cached\Storage\Psr6Cache(($this->privates['cache.flysystem.psr6'] ?? $this->getCache_Flysystem_Psr6Service()), 'flysystem', NULL)), ['disable_asserts' => false]);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $d->addInstance('cache.flysystem.psr6', ($this->privates['cache.flysystem.psr6'] ?? $this->getCache_Flysystem_Psr6Service()));
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \App\Twig\AppExtension((new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Service\\MarkdownHelper' => ['privates', 'App\\Service\\MarkdownHelper', 'getMarkdownHelperService.php', true],
            'App\\Service\\UploaderHelper' => ['privates', 'App\\Service\\UploaderHelper', 'getUploaderHelperService.php', true],
        ], [
    ...
    {
        return $this->privates['assets.packages'] = new \Symfony\Component\Asset\Packages(new \Symfony\Component\Asset\PathPackage('', new \Symfony\Component\Asset\VersionStrategy\JsonManifestVersionStrategy((\dirname(__DIR__, 4).'/public/build/manifest.json')), ($this->privates['assets.context'] ?? $this->getAssets_ContextService())), []);
    }
    ...
    /**
     * Gets the private 'cache.flysystem.psr6' shared service.
     *
     * @return \Symfony\Component\Cache\Adapter\TraceableAdapter
     */
    protected function getCache_Flysystem_Psr6Service()
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('NQ5YkSEZ5z', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
        $a->setLogger(($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));

        return $this->privates['cache.flysystem.psr6'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter($a);
    }
    ...
    protected function getDebug_Security_Access_DecisionManagerService()
    {
        return $this->privates['debug.security.access.decision_manager'] = new \Symfony\Component\Security\Core\Authorization\TraceableAccessDecisionManager(new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(new RewindableGenerator(function () {
            ...
            yield 2 => ($this->privates['debug.security.voter.App\\Security\\Voter\\ArticleVoter'] ?? $this->load('getArticleVoterService.php'));
    ...
    /**
     * Gets the private 'oneup_flysystem.uploads_adapter_adapter' shared service.
     *
     * @return \League\Flysystem\Adapter\Local
     */
    protected function getOneupFlysystem_UploadsAdapterAdapterService()
    {
        return $this->privates['oneup_flysystem.uploads_adapter_adapter'] = new \League\Flysystem\Adapter\Local((\dirname(__DIR__, 4).'/public/uploads'), 2, 2, ['file' => ['public' => 420, 'private' => 384], 'dir' => ['public' => 493, 'private' => 448]]);
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        ]), new \Symfony\Component\Translation\Formatter\MessageFormatter(new \Symfony\Component\Translation\IdentityTranslator()), 'en', ['translation.loader.php' => [0 => 'php'], 'translation.loader.yml' => [0 => 'yaml', 1 => 'yml'], 'translation.loader.xliff' => [0 => 'xlf', 1 => 'xliff'], 'translation.loader.po' => [0 => 'po'], 'translation.loader.mo' => [0 => 'mo'], 'translation.loader.qt' => [0 => 'ts'], 'translation.loader.csv' => [0 => 'csv'], 'translation.loader.res' => [0 => 'res'], 'translation.loader.dat' => [0 => 'dat'], 'translation.loader.ini' => [0 => 'ini'], 'translation.loader.json' => [0 => 'json']], ['cache_dir' => ($this->targetDir.''.'/translations'), 'debug' => true, 'resource_files' => ['af' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.af.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.af.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.af.xlf')], 'ar' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.ar.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.ar.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.ar.xlf'), 3 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.ar.xliff'), 4 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.ar.xliff')], 'az' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.az.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.az.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.az.xlf')], 'be' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.be.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.be.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.be.xlf')], 'bg' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.bg.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.bg.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.bg.xlf'), 3 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.bg.xliff')], 'bs' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.bs.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.bs.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.bs.xlf')], 'ca' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.ca.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.ca.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.ca.xlf'), 3 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.ca.xliff')], 'cs' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.cs.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.cs.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.cs.xlf'), 3 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.cs.xliff')], 'cy' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.cy.xlf')], 'da' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.da.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.da.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.da.xlf'), 3 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.da.xliff'), 4 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.da.xliff')], 'de' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.de.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.de.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.de.xlf'), 3 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.de.xliff'), 4 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.de.xliff')], 'el' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.el.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.el.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.el.xlf')], 'en' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.en.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.en.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.en.xlf'), 3 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.en.xliff'), 4 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.en.xliff'), 5 => (\dirname(__DIR__, 4).'/translations/security.en.yaml')], 'es' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.es.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.es.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.es.xlf'), 3 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.es.xliff'), 4 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.es.xliff')], 'et' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.et.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.et.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.et.xlf')], 'eu' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.eu.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.eu.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.eu.xlf'), 3 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.eu.xliff')], 'fa' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.fa.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.fa.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.fa.xlf'), 3 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.fa.xliff')], 'fi' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.fi.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.fi.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.fi.xlf'), 3 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.fi.xliff')], 'fr' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.fr.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.fr.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.fr.xlf'), 3 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.fr.xliff'), 4 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.fr.xliff')], 'gl' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.gl.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.gl.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.gl.xlf')], 'he' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.he.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.he.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.he.xlf')], 'hr' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.hr.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.hr.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.hr.xlf')], 'hu' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.hu.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.hu.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.hu.xlf'), 3 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.hu.xliff'), 4 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.hu.xliff')], 'hy' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.hy.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.hy.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.hy.xlf')], 'id' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.id.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.id.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.id.xlf'), 3 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.id.xliff'), 4 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.id.xliff')], 'it' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.it.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.it.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.it.xlf'), 3 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.it.xliff'), 4 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.it.xliff')], 'ja' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.ja.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.ja.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.ja.xlf'), 3 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.ja.xliff')], 'lb' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.lb.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.lb.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.lb.xlf')], 'lt' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.lt.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.lt.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.lt.xlf'), 3 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.lt.xliff'), 4 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.lt.xliff')], 'lv' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.lv.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.lv.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.lv.xlf')], 'mn' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.mn.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.mn.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.mn.xlf')], 'my' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.my.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.my.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.my.xlf')], 'nb' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.nb.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.nb.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.nb.xlf'), 3 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.nb.xliff')], 'nl' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.nl.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.nl.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.nl.xlf'), 3 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.nl.xliff'), 4 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.nl.xliff')], 'nn' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.nn.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.nn.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.nn.xlf'), 3 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.nn.xliff')], 'no' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.no.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.no.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.no.xlf')], 'pl' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.pl.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.pl.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.pl.xlf'), 3 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.pl.xliff'), 4 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.pl.xliff')], 'pt' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.pt.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.pt.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.pt.xlf'), 3 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.pt.xliff')], 'pt_BR' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.pt_BR.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.pt_BR.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.pt_BR.xlf'), 3 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.pt_BR.xliff'), 4 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.pt_BR.xliff')], 'ro' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.ro.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.ro.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.ro.xlf'), 3 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.ro.xliff'), 4 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.ro.xliff')], 'ru' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.ru.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.ru.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.ru.xlf'), 3 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.ru.xliff'), 4 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.ru.xliff')], 'sk' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.sk.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.sk.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.sk.xlf'), 3 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.sk.xliff')], 'sl' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.sl.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.sl.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.sl.xlf'), 3 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.sl.xliff')], 'sq' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.sq.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.sq.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.sq.xlf')], 'sr_Cyrl' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.sr_Cyrl.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.sr_Cyrl.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.sr_Cyrl.xlf')], 'sr_Latn' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.sr_Latn.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.sr_Latn.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.sr_Latn.xlf')], 'sv' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.sv.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.sv.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.sv.xlf'), 3 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.sv.xliff'), 4 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.sv.xliff')], 'th' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.th.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.th.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.th.xlf'), 3 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.th.xliff')], 'tl' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.tl.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.tl.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.tl.xlf')], 'tr' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.tr.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.tr.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.tr.xlf'), 3 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.tr.xliff')], 'uk' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.uk.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.uk.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.uk.xlf'), 3 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.uk.xliff'), 4 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.uk.xliff')], 'ur' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.ur.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.ur.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.ur.xlf')], 'uz' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.uz.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.uz.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.uz.xlf')], 'vi' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.vi.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.vi.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.vi.xlf'), 3 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.vi.xliff')], 'zh_CN' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.zh_CN.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.zh_CN.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.zh_CN.xlf'), 3 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.zh_CN.xliff')], 'zh_TW' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.zh_TW.xlf'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.zh_TW.xlf'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.zh_TW.xlf'), 3 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.zh_TW.xliff')], 'bs_Latn_BA' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.bs_Latn_BA.xliff')], 'eo' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.eo.xliff')], 'hr_HR' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.hr_HR.xliff')], 'ky' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.ky.xliff'), 1 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.ky.xliff')], 'pt_PT' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.pt_PT.xliff')], 'sr_Latin' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.sr_Latin.xliff')], 'zh' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.zh.xliff')], 'zh_HK' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.zh_HK.xliff')], 'sw' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.sw.xliff')]], 'scanned_directories' => [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations'), 3 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations'), 4 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-paginator-bundle/Resources/translations'), 5 => (\dirname(__DIR__, 4).'/translations'), 6 => (\dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/translations'), 7 => (\dirname(__DIR__, 4).'/src/Resources/FrameworkBundle/translations'), 8 => (\dirname(__DIR__, 4).'/vendor/symfony/web-server-bundle/translations'), 9 => (\dirname(__DIR__, 4).'/src/Resources/WebServerBundle/translations'), 10 => (\dirname(__DIR__, 4).'/vendor/sensio/framework-extra-bundle/src/translations'), 11 => (\dirname(__DIR__, 4).'/src/Resources/SensioFrameworkExtraBundle/translations'), 12 => (\dirname(__DIR__, 4).'/vendor/symfony/twig-bundle/translations'), 13 => (\dirname(__DIR__, 4).'/src/Resources/TwigBundle/translations'), 14 => (\dirname(__DIR__, 4).'/vendor/symfony/web-profiler-bundle/translations'), 15 => (\dirname(__DIR__, 4).'/src/Resources/WebProfilerBundle/translations'), 16 => (\dirname(__DIR__, 4).'/vendor/symfony/monolog-bundle/translations'), 17 => (\dirname(__DIR__, 4).'/src/Resources/MonologBundle/translations'), 18 => (\dirname(__DIR__, 4).'/vendor/symfony/debug-bundle/translations'), 19 => (\dirname(__DIR__, 4).'/src/Resources/DebugBundle/translations'), 20 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-markdown-bundle/translations'), 21 => (\dirname(__DIR__, 4).'/src/Resources/KnpMarkdownBundle/translations'), 22 => (\dirname(__DIR__, 4).'/vendor/php-http/httplug-bundle/src/translations'), 23 => (\dirname(__DIR__, 4).'/src/Resources/HttplugBundle/translations'), 24 => (\dirname(__DIR__, 4).'/vendor/nexylan/slack-bundle/src/translations'), 25 => (\dirname(__DIR__, 4).'/src/Resources/NexySlackBundle/translations'), 26 => (\dirname(__DIR__, 4).'/vendor/symfony/maker-bundle/src/translations'), 27 => (\dirname(__DIR__, 4).'/src/Resources/MakerBundle/translations'), 28 => (\dirname(__DIR__, 4).'/vendor/doctrine/doctrine-cache-bundle/translations'), 29 => (\dirname(__DIR__, 4).'/src/Resources/DoctrineCacheBundle/translations'), 30 => (\dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/translations'), 31 => (\dirname(__DIR__, 4).'/src/Resources/DoctrineBundle/translations'), 32 => (\dirname(__DIR__, 4).'/vendor/doctrine/doctrine-migrations-bundle/translations'), 33 => (\dirname(__DIR__, 4).'/src/Resources/DoctrineMigrationsBundle/translations'), 34 => (\dirname(__DIR__, 4).'/src/Resources/KnpTimeBundle/translations'), 35 => (\dirname(__DIR__, 4).'/vendor/doctrine/doctrine-fixtures-bundle/translations'), 36 => (\dirname(__DIR__, 4).'/src/Resources/DoctrineFixturesBundle/translations'), 37 => (\dirname(__DIR__, 4).'/vendor/stof/doctrine-extensions-bundle/src/translations'), 38 => (\dirname(__DIR__, 4).'/src/Resources/StofDoctrineExtensionsBundle/translations'), 39 => (\dirname(__DIR__, 4).'/src/Resources/KnpPaginatorBundle/translations'), 40 => (\dirname(__DIR__, 4).'/vendor/symfony/security-bundle/translations'), 41 => (\dirname(__DIR__, 4).'/src/Resources/SecurityBundle/translations'), 42 => (\dirname(__DIR__, 4).'/vendor/liip/imagine-bundle/translations'), 43 => (\dirname(__DIR__, 4).'/src/Resources/LiipImagineBundle/translations'), 44 => (\dirname(__DIR__, 4).'/vendor/oneup/flysystem-bundle/translations'), 45 => (\dirname(__DIR__, 4).'/src/Resources/OneupFlysystemBundle/translations'), 46 => (\dirname(__DIR__, 4).'/vendor/symfony/webpack-encore-bundle/src/translations'), 47 => (\dirname(__DIR__, 4).'/src/Resources/WebpackEncoreBundle/translations'), 48 => (\dirname(__DIR__, 4).'/src/Resources/translations')], 'cache_vary' => ['scanned_directories' => [0 => 'vendor/symfony/validator/Resources/translations', 1 => 'vendor/symfony/form/Resources/translations', 2 => 'vendor/symfony/security-core/Resources/translations', 3 => 'vendor/knplabs/knp-time-bundle/Resources/translations', 4 => 'vendor/knplabs/knp-paginator-bundle/Resources/translations', 5 => 'translations', 6 => 'vendor/symfony/framework-bundle/translations', 7 => 'src/Resources/FrameworkBundle/translations', 8 => 'vendor/symfony/web-server-bundle/translations', 9 => 'src/Resources/WebServerBundle/translations', 10 => 'vendor/sensio/framework-extra-bundle/src/translations', 11 => 'src/Resources/SensioFrameworkExtraBundle/translations', 12 => 'vendor/symfony/twig-bundle/translations', 13 => 'src/Resources/TwigBundle/translations', 14 => 'vendor/symfony/web-profiler-bundle/translations', 15 => 'src/Resources/WebProfilerBundle/translations', 16 => 'vendor/symfony/monolog-bundle/translations', 17 => 'src/Resources/MonologBundle/translations', 18 => 'vendor/symfony/debug-bundle/translations', 19 => 'src/Resources/DebugBundle/translations', 20 => 'vendor/knplabs/knp-markdown-bundle/translations', 21 => 'src/Resources/KnpMarkdownBundle/translations', 22 => 'vendor/php-http/httplug-bundle/src/translations', 23 => 'src/Resources/HttplugBundle/translations', 24 => 'vendor/nexylan/slack-bundle/src/translations', 25 => 'src/Resources/NexySlackBundle/translations', 26 => 'vendor/symfony/maker-bundle/src/translations', 27 => 'src/Resources/MakerBundle/translations', 28 => 'vendor/doctrine/doctrine-cache-bundle/translations', 29 => 'src/Resources/DoctrineCacheBundle/translations', 30 => 'vendor/doctrine/doctrine-bundle/translations', 31 => 'src/Resources/DoctrineBundle/translations', 32 => 'vendor/doctrine/doctrine-migrations-bundle/translations', 33 => 'src/Resources/DoctrineMigrationsBundle/translations', 34 => 'src/Resources/KnpTimeBundle/translations', 35 => 'vendor/doctrine/doctrine-fixtures-bundle/translations', 36 => 'src/Resources/DoctrineFixturesBundle/translations', 37 => 'vendor/stof/doctrine-extensions-bundle/src/translations', 38 => 'src/Resources/StofDoctrineExtensionsBundle/translations', 39 => 'src/Resources/KnpPaginatorBundle/translations', 40 => 'vendor/symfony/security-bundle/translations', 41 => 'src/Resources/SecurityBundle/translations', 42 => 'vendor/liip/imagine-bundle/translations', 43 => 'src/Resources/LiipImagineBundle/translations', 44 => 'vendor/oneup/flysystem-bundle/translations', 45 => 'src/Resources/OneupFlysystemBundle/translations', 46 => 'vendor/symfony/webpack-encore-bundle/src/translations', 47 => 'src/Resources/WebpackEncoreBundle/translations', 48 => 'src/Resources/translations']]]);
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->setConstraintValidatorFactory(new \Symfony\Component\Validator\ContainerConstraintValidatorFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Validator\\UniqueUserValidator' => ['privates', 'App\\Validator\\UniqueUserValidator', 'getUniqueUserValidatorService.php', true],
            ...
            'App\\Validator\\UniqueUserValidator' => '?',
    ...
    private function getDynamicParameter(string $name)
    {
        switch ($name) {
            ...
            case 'uploads_base_url': $value = $this->getEnv('string:SITE_BASE_URL').'/uploads'; break;
            ...
            case 'liip_imagine.resolvers': $value = [
                'flysystem_resolver' => [
                    'flysystem' => [
                        ...
                        'root_url' => $this->getEnv('string:SITE_BASE_URL').'/uploads',
                        'visibility' => 'public',
                    ],
                ],
                'default' => [
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles_metadata' => [
                ...
                'NexySlackBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/nexylan/slack-bundle/src'),
