...
include_once \dirname(__DIR__, 4).'/src/Controller/ArticleAdminController.php';

$this->services['App\\Controller\\ArticleAdminController'] = $instance = new \App\Controller\ArticleAdminController();

$instance->setContainer(($this->privates['.service_locator.Kti1w.j'] ?? $this->load('get_ServiceLocator_Kti1w_JService.php'))->withContext('App\\Controller\\ArticleAdminController', $this));
